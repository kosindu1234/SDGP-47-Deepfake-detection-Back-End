...
def detect(filename):
    ...
    new_model = load_model(r'model.h5') #model path
    new_model.summary()
    ...
    test_video = (filename )#video path
    ...
    if(prediction(test_video)>=0.55):
        ...
        return 'The predicted class of the video is FAKE'
    else:
        #print(f'The predicted class of the video is REAL')
        return 'The predicted class of the video is REAL'
